...
//初始化界面文字
ui->lineEdit_MoveDistance->setText(QString::number(100000));
...
void SettingDialog::on_pushButton_FWD_clicked()
{
    ...
    Mediator::GetIns()->MachineOp(MOVE_UP,GetDistance,1);
}
...
{
    int GetDistance = ui->lineEdit_MoveDistance->text().toInt();
    Mediator::GetIns()->MachineOp(MOVE_DOWN,GetDistance,1);
}

void SettingDialog::on_pushButton_LEFT_clicked()
{
    int GetDistance = ui->lineEdit_MoveDistance->text().toInt();
    Mediator::GetIns()->MachineOp(MOVE_LEFT,GetDistance,1);
}

void SettingDialog::on_pushButton_RIGHT_clicked()
{
   int GetDistance = ui->lineEdit_MoveDistance->text().toInt();
   Mediator::GetIns()->MachineOp(MOVE_RIGHT,GetDistance,1);
}
